...
from bias_gan_t_p.code.src.model import CycleGAN, DataModule, ConstrainedGenerator
...
class Inference():
    ...
    def inv_transform(data, reference=None):
        ...
        print("doing inv_transform", config.epsilon)
...
class EvaluateCheckpoints():
    ...
    def read_test_data(self):
        ...
        #print("data -read_test_data", data)
        data.convert_units()
