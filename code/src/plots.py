...
class PlotAnalysis():
    ...
    def histograms_pr(self, single_plot=False, ax=None, show_legend=True, annotate=True,log=True,xlim_end=150):
    ...
    def histograms_t(self, single_plot=False, ax=None, show_legend=True, annotate=True,log=True,xlim_end=150):
